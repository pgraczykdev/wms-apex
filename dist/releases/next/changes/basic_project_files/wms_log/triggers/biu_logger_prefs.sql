...
-- changeset WMS_LOG:1783767499875 stripComments:false  logicalFilePath:basic_project_files\wms_log\triggers\biu_logger_prefs.sql
-- sqlcl_snapshot src/database/wms_log/triggers/biu_logger_prefs.sql:null:e31a78081c5001a0077113e19341eb5fa63ea80f:create

create or replace editionable trigger wms_log.biu_logger_prefs before
    insert or update on wms_log.logger_prefs
    for each row
begin
...
alter trigger wms_log.biu_logger_prefs enable;
